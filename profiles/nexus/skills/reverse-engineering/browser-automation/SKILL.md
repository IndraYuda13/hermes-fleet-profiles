...
description: |
  Pintu masuk otomatisasi terpadu. Mencakup otomatisasi browser (Playwright) dan otomatisasi aplikasi desktop Windows (OpenReverse).
  Skenario Browser: Membuka web, klik, isi formulir, scraping, screenshot, login otomatis, interaksi penetrasi halaman.
  Skenario Desktop: Pengoperasian GUI tool seperti IDA/x64dbg, Windows UI Automation, interaksi berbasis visual, serta penangkapan lalu lintas jaringan aplikasi desktop.
  Kata kunci pemicu: otomatisasi browser, otomatisasi desktop, buka web, isi form, scrape, screenshot, login otomatis, Playwright, agent-browser, headless, OpenReverse, UIA, CUA, operasi desktop, otomatisasi Windows.
---
