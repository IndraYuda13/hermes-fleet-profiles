...
- This skill provides analysis and scenarios, not guaranteed financial outcomes.
- Never present predictions as certainty; use conditional framing.
- Always state key risks and uncertainty before action-oriented suggestions.
