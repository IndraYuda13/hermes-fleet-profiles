...
See also: `references/neo-brutalism.md` for specific design tokens and implementation patterns when building Minimalist Neo-Brutalist or anti-AI-slop web applications.
