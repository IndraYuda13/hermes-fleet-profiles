...
name: edr-bypass-re
description: |
  Reverse engineering implementasi pertahanan → bypass terarah oleh Red Team. Lakukan reverse engineering pada tabel hook EDR / Defender / AV, provider ETW, dan implementasi AMSI terlebih dahulu, lalu tulis unhooking terarah / indirect syscall / ETW patch / call stack spoofing. Mengacu pada evasasi pertahanan MITRE ATT&CK T1562.
  Kata kunci pemicu: EDR bypass, AV bypass, evasasi pertahanan, unhook, direct syscall, indirect syscall, Hell's Gate, Halo's Gate, Tartarus Gate, ETW patch, AMSI patch, call stack spoofing, hardware breakpoint Blindside, MITRE T1562, ntdll unhook, kernel callback, bypass CrowdStrike, bypass Defender, Sentinel One bypass, Elastic Defend, Sysmon evasion, PPID spoof, Sleep mask, Process Hollowing, Reflective DLL.
---
