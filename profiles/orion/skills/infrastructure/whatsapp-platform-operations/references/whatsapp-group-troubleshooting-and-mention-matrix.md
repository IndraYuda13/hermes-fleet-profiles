...
- **Phone JID:** `@6283121795912`
- **LID Handle:** `@280595213078677` (e.g. `@280595213078677AW.ai`)
...
```ini
WHATSAPP_MENTION_PATTERNS=["@6283121795912", "@280595213078677", "AW.ai", "@AW.ai", "Akun Wa Gpt", "\\bOrion\\b", "\\bbot\\b"]
```
...
Baileys emits participant/bot IDs with device suffixes: `280595213078677:2@lid` or `6283121795912:2@s.whatsapp.net`.
...
def normalize_whatsapp_id(value: str) -> str:
    ...
    return value
```
This ensures `@280595213078677` tags generated by mobile UI autocomplete match `botIds` reliably.
