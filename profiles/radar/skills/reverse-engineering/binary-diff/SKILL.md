...
name: binary-diff
description: |
  Migrasi simbol antar-versi dan binary diffing. Gunakan saat Anda memiliki hasil simbol/reverse engineering dari versi lama dan perlu memindahkannya dengan cepat ke versi baru.
  Skenario penggunaan: Kernel tanpa PDB menggunakan simbol versi lama, migrasi nama fungsi secara massal setelah pembaruan aplikasi, atau menentukan offset baru secara cepat.
  Metode utama: Menggunakan LLM untuk pembandingan struktur secara terprogram dengan biaya sangat efisien.
  Kata kunci pemicu: migrasi simbol, bindiff, beda versi, PDB hilang, migrasi offset fungsi, symbol migration, binary diff, komparasi versi.
---
