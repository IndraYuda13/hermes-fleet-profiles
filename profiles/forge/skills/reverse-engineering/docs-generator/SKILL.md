...
name: docs-generator
description: |
  Membuat dokumentasi teknis berorientasi tugas dengan penyajian progresif. Gunakan saat menulis README, dokumentasi API, arsitektur, atau dokumen markdown.
  Gunakan juga skill ini di AKHIR setiap tugas reverse engineering, penetration testing, CTF, atau analisis keamanan yang telah selesai untuk menghasilkan laporan formal di direktori proyek pengguna.
  Kata kunci pemicu: buat laporan, buat dokumen, cetak laporan, writeup, dokumentasi teknis, report, documentation.
---
