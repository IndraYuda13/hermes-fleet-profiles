---
name: apk-reverse
description: Gunakan saat melakukan reverse engineering Android APK di lingkungan CLI. Cocok untuk APK unpacking, Java decompilation, smali modification, repackaging, Frida dynamic Hook, serta beralih ke analisis native (.so). Utamakan penggunaan tool lokal seperti jadx, apktool, frida, adb, ida-reverse, dan radare2.
---
