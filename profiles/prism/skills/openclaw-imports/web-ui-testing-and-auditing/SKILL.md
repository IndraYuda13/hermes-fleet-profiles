...
1. **Deep-Flow Verification**: Never limit UI verification to the landing page or initial state. Always click through multi-step wizards, sub-menus, search dialogs, support pages, form fields, and checkout flows.
...
- [ ] **Home / Hero**: Search input, tag pills, CTA buttons.
...
- [ ] **Wizard Step 4 (Input Forms)**: Input field spacing, label contrast, helper text duplication check.
