...
- Skip results marked sponsored/ads.
- Cross-check key claims with at least 2 independent sources.
- If DDG output looks malformed or incomplete, retry query variant and verify with direct source fetch.
